...
# The starting and ending stations are indicated when creating a route,
...
class Route
  ...
  def validate!
    if Station != @start_station.class && @end_station.class
      raise 'Rout must have at least 2 stations!'
    end
